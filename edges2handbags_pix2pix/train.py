...
if __name__ == '__main__':
    opt = TrainOptions().parse()   # Parse command line arguments
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):
        ...
        print('End of epoch %d / %d \t Time Taken: %d sec \t Epoch Loss: %f' % (epoch, opt.n_epochs + opt.n_epochs_decay, time.time() - epoch_start_time, average_loss))
    ...
    plt.savefig('training_loss_curve.png', format='png')
